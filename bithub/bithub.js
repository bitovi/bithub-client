...
steal(
	...
	function(can, PageSwitcher, Homepage, Profile, Activities, Filterbar, Login, Newpost, EventDetails, prepareParams, Modals, Event, Tag, User, loadtime) {
		...
		for (var v in views) {
			can.route(routePrefix + '/'+views[v], { page: 'homepage', category:'all', project: 'all', timespan: 'week', view: views[v] });
			...
			for (var p in projects) {
				...
				can.route(routePrefix + '/'+views[v]+'/'+projects[p], { page: 'homepage', category: 'all', timespan: 'week', view: views[v], project: projects[p]});
				...
				for (var c in categories) {
					...
					can.route(routePrefix + '/'+views[v]+'/'+categories[c], { page: 'homepage', project: 'all', timespan: 'week', view: views[v], category: categories[c] });
					can.route(routePrefix + '/'+views[v]+'/'+projects[p]+'/'+categories[c], { page: 'homepage', timespan: 'week', view: views[v], project: projects[p], category: categories[c]});
					...
					if (categories[c] !== 'twitter' && categories[c] !== 'code') {
						...
						can.route(routePrefix + '/'+views[v]+'/'+categories[c]+'s', { page: 'homepage', project: 'all', timespan: 'week', view: views[v], category: categories[c] });
						can.route(routePrefix + '/'+views[v]+'/'+projects[p]+'/'+categories[c]+'s', { page: 'homepage', timespan: 'week', view: views[v], project: projects[p], category: categories[c]});
					}
				}
			}
		}
